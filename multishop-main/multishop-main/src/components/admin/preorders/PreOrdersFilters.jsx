...
import { preOrderStatusOptions } from "@/components/hooks/useAdminPreOrders";

export default function PreOrdersFilters({ 
  searchTerm, 
  setSearchTerm, 
  statusFilter, 
  setStatusFilter, 
    ...
    <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Tìm kiếm phiên bán trước..."
            value={searchTerm}
